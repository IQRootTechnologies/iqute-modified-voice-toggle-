...
public class Electronics extends Ecommerce
{
    public ToggleButton toggleButtonEle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButtonEle =(ToggleButton) findViewById(R.id.togglebutton2);
        ...
        toggleButtonEle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public void onEndOfSpeech() {
        ...
        toggleButtonEle.setChecked(false);
    }
