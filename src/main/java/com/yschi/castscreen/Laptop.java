...
public class Laptop extends Ecommerce
{
    public ToggleButton toggleButtonLap;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonLap =(ToggleButton) findViewById(R.id.togglebutton6);
        ...
        toggleButtonLap.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public void onEndOfSpeech() {
        ...
        toggleButtonLap.setChecked(false);
    }
