...
public class Watches extends Ecommerce
{
    public ToggleButton toggleButtonWat;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonWat =(ToggleButton) findViewById(R.id.togglebutton7);
        ...
        toggleButtonWat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public void onEndOfSpeech() {
        ...
        toggleButtonWat.setChecked(false);
    }
