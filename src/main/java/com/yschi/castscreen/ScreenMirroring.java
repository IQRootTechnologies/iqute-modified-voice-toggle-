...
public class ScreenMirroring extends HomePage {
    ...
    private static final String TAG = "ScreenMirroring";
...
//        ipEditText.setText(mContext.getSharedPreferences(PREF_COMMON, 0).getString(PREF_KEY_INPUT_RECEIVER, ""));
  ...
  /*  public  void startElectronics(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Electronics", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Electronics.class));
    }
    public  void startGrocery(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Grocery", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Grocery.class));
    }
    public  void startBook(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Books", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Books.class));
    }
    public  void startFashion(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Fashion", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Fashion.class));
    }
    public  void startLaptop(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Laptop", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Laptop.class));
    }
    public  void startWatch(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Watch", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Watches.class));
    }
    public  void startNext(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Next", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Next.class));
    }
    public  void startOthers(View v)
    {
        Toast.makeText(ScreenMirroring.this,
                "Others", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ScreenMirroring.this,Others.class));
    }
    ...
    startActivity(new Intent(ScreenMirroring.this,Ecommerce.class));
    }
*/
