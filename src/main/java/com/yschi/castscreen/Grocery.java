...
public class Grocery extends Ecommerce
{
    public ToggleButton toggleButtonGro;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonGro =(ToggleButton) findViewById(R.id.togglebutton3);
        ...
        toggleButtonGro.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public void onEndOfSpeech() {
        ...
        toggleButtonGro.setChecked(false);
    }
