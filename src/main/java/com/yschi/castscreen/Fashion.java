...
public class Fashion extends Ecommerce
{
    public ToggleButton toggleButtonFas;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonFas =(ToggleButton) findViewById(R.id.togglebutton5);
        ...
        toggleButtonFas.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public void onEndOfSpeech() {
        ...
        toggleButtonFas.setChecked(false);
    }
